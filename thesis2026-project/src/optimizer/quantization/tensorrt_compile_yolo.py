...
def export_engine(model_path: str, int8: bool) -> str:
...
if __name__ == "__main__":
    # fp32_engine = export_engine(MODEL_PT, int8=False)
    # print(f"[OK] FP32 engine: {fp32_engine}")

    int8_engine = export_engine(MODEL_PT, int8=True)
